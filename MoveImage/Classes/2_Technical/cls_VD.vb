...
Public Class cls_VD
    ...
    Public Sub New()
        ...
        type_doc = "Ведомость дефектов"
        dirName = "2_Техническая документация\ВД - (Ведомость дефектов)\Ведомость дефектов (Подписанные)\"
        nameTable_TypeDoc = "tbl_VD"
