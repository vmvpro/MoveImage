...
Public Class cls_IZV_OIR
	...
	Public Sub New()
        ...
        type_doc = "Извещение ОИР"
		dirName = "2_Техническая документация\ИЗВ_ОИР - (Извещение об изменении расцеховки)\"

		rootNameDocument = "IZV_OIR"
    ...
    Protected Overrides Sub defineName()
        ...
        mas_SaveImages = New String() {"ИЗВ_ОИР " & temp02_num, temp03_cherteg}
        mas_SaveFolder = New String() {"ИЗВ_ОИР " & temp02_num, temp03_cherteg, temp06_prim}
        mas_FullPathFolder = New String() {"ИЗВ_ОИР " & temp02_num, temp03_cherteg, temp06_prim}
