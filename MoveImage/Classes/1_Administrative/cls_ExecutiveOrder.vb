Imports System.Text
Public Class cls_ExecutiveOrder
    ...
    Protected Overrides Sub defineName()
        ...
        mas_SaveImages = New String() {"Р ", temp02_num, " от ", temp11_dates}
        mas_SaveFolder = New String() {"Распоряжение ", temp02_num, " от ", temp11_dates, temp18_txt1}
        mas_FullPathFolder = New String() {field11_dates.Value.Year & "\", "Распоряжение ", temp02_num, " от ", temp11_dates, temp18_txt1}
