...
Public Class cls_Protocol
	...
	Public Sub New()
		...
		dirName = "1_Административная документация\Протоколы\"
	...
	Protected Overrides Sub defineName()
		...
		mas_SaveImages = New String() {"Протокол ", temp02_num, " от ", temp11_dates}
		mas_SaveFolder = New String() {"Протокол ", temp02_num, " от ", temp11_dates, temp18_txt1}
		mas_FullPathFolder = New String() {field11_dates.Value.Year & "\", "Протокол ", temp02_num, " от ", temp11_dates, temp18_txt1}
