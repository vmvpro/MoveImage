...
Public Class cls_Akt
	...
	Public Sub New()
		...
		dirName = "1_Административная документация\Акты\Акты (Предприятия)\"
	...
	Protected Overrides Sub defineName()
		...
		mas_SaveImages = New String() {"Акт ", temp02_num, " от ", temp11_dates}
		mas_SaveFolder = New String() {"Акт ", temp02_num, " от ", temp11_dates, temp18_txt1}
		mas_FullPathFolder = New String() {field11_dates.Value.Year & "\", "Акт ", temp02_num, " от ", temp11_dates, temp18_txt1}
